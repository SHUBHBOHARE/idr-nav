...
import { Compass, ArrowRight, AlertTriangle, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-surface border border-primary/30 p-4 rounded-xl flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-4 text-xs font-mono">
          ...
          <div className="bg-card px-3 py-1.5 rounded border border-border">
            ...
            <span className="font-bold text-warning">{state.current_lat.toFixed(6)}, {state.current_lon.toFixed(6)}</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-card p-4 rounded-xl border border-border">
          ...
          <div className="text-3xl font-black text-danger">{state.drift_m.toFixed(2)} m</div>
        ...
        <div className="bg-card p-4 rounded-xl border border-border">
          ...
          <div className="text-3xl font-black text-warning">{state.drift_percentage.toFixed(2)} %</div>
        ...
        <div className="bg-card p-4 rounded-xl border border-border">
          ...
          <div className="text-3xl font-black text-secondary">{state.outage_duration_s.toFixed(1)} s</div>
